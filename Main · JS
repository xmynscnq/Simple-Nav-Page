...
const FAVICON_API = 'https://wz9818.xmynscnq.dpdns.org/www.google.com/s2/favicons?sz=64&domain=';
const BG_API      = 'https://wz9818.xmynscnq.dpdns.org/bing.img.run/rand.php?t=';
